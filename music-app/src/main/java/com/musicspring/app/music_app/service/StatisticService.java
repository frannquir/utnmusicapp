...
public class StatisticService {
    ...
    @Autowired
    public StatisticService(AlbumRepository albumRepository, ArtistRepository artistRepository, SongRepository songRepository, SongMapper songMapper, AlbumMapper albumMapper) {
